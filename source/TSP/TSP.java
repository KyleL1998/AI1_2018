...
boolean runCases = false; //if this is true change testCase just below to the case you wanna test
...
final float mutRate = .01f; 
final float crossoverRate = .95f;
final float keepBest = .25f; //keep the best 10% of individuals in the population
...
float scaleMutationRate = .0001f; //really small increased chance for mutation
...
public void draw(){
  ...
  if(noChange < capGen){ // if there hasn't been change for a while alter the algorithm
    if(generation% 50 == 0) // a scaling mutationRate so it doesn't get stuck in later generations
      mutationRate = Math.min(.025f, mutationRate+=scaleMutationRate);
...
//*****************************************************************************************
public void checkForImprovement(ArrayList<DNA> useThis){//changes the bestPath
  for(DNA d : useThis){
...
//*****************************************************************************************
public void normalizeFitness(){ // go read about
    double sum = 0;
...
//*****************************************************************************************
public void newGeneration(ArrayList<DNA> input){
...
//*****************************************************************************************
public DNA crossoverMatch(DNA d1, DNA d2){
...
//*****************************************************************************************
public ArrayList<DNA> selectionProbabilistic(ArrayList<DNA> nxt){
...
//*****************************************************************************************
public DNA selectedByProb(ArrayList<DNA> nxt){
  int index = 0;
...
//*****************************************************************************************
public void displayAll(DNA curr){
  background(255);
  strokeWeight(1);
...
//*****************************************************************************************
public float pathCost(int[] input){
  float pathDist = 0;
...
class DNA implements Comparable<DNA>{
  ...
  public double calcFitness(double f){return 1/(f+1);}
  ...
  public void normalizeFitness(double sum){fitnessN = (this.fitness)/(sum);}
  
  public int getIndex(int i){return order[i];}
  public double getFitness(){return fitness;}
  public double getFitnessN(){return fitnessN;}
  public void swapSpots(int i){
...
class Item{
  ...
  public void settings() {  size(650, 850); }
